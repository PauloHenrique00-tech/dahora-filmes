  ...
  const itemDaListaDeFavoritos = ({ item }: ItemDaListaDeFavoritosProps) => (
    ...
    >
      ...
      <Pressable
        ...
        // Ao chamar uma função (no caso, removeFilme) que necessite de parâmetros (no caso,
        // item.id), obrigatoriamente, a prop de evento (onPress) deve usar a sintaxe com arrow function
