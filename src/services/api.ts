...
(tempo de execução). Informações como: versão, build,
variáveis de ambiente definidas no app.config.ts
(em extra) */
import Constants from "expo-constants";

/* O ? para garantir que não dê erro caso alguma das propriedas 
